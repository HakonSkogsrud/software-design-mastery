...
def generate_spending_report(
    ...
    should_include: TransactionFilter,
) -> SpendingReport:
    filtered_transactions = [
        transaction for transaction in transactions if should_include(transaction)
    ]
...
def main() -> None:
    ...
    report = generate_spending_report(
        transactions,
        should_include=large_purchases_only,
    )
